...
<div id="view-home" class="view active" role="main" tabindex="-1">
  ...
  <section class="hero" aria-labelledby="hero-h1">
    ...
    <div class="hero-inner">
      ...
      <p class="hero-sub">Ville de Chanteloup-les-Vignes &nbsp;·&nbsp; {nb_sources} médias &nbsp;·&nbsp; {RETENTION} jours</p>
  ...
  <footer class="site-footer" role="contentinfo">
    <div class="footer-inner">
      ...
      <div class="footer-links">
        ...
        <span class="footer-link">{nb_sources} médias · Mémoire {RETENTION} jours</span>
      </div>
...
<div id="view-pouls" class="view" role="main">
  <section class="sec reveal" aria-labelledby="sec-pouls" style="padding-top:2.5rem">
    ...
    <p class="pouls-intro">L'activité de la veille en un coup d'œil : le volume d'articles publiés sur 14 jours et les médias les plus actifs sur {RETENTION} jours.</p>
    ...
    <div class="pulse-panel">
      ...
      <div class="pulse-col">
        <div class="pulse-label">Sources les plus actives<span>{RETENTION} j</span></div>
        <div id="sources-grid" class="src-list" role="list" aria-label="Sources les plus actives"></div>
      </div>
    </div>

    <div class="rep-card reveal">
      <div class="pulse-label">Répartition par périmètre<span>{RETENTION} j · 3 zones</span></div>
  ...
  <footer class="site-footer" role="contentinfo">
    <div class="footer-inner">
      <span class="footer-logo">La Vigie</span>
      <div class="footer-links"><span class="footer-link">{nb_sources} médias surveillés · {RETENTION} jours de mémoire</span></div>
      <span class="footer-date">Mis à jour : {date_maj}</span>
    </div>
  </footer>
</div>
...
<div id="view-feed" class="view" role="main">
  ...
  <footer class="site-footer" role="contentinfo">
    <div class="footer-inner">
      <span class="footer-logo">La Vigie</span>
      <div class="footer-links">
        <span class="footer-link">{nb_sources} médias surveillés · {RETENTION} jours de mémoire</span>
      </div>
      <span class="footer-date">Mis à jour : {date_maj}</span>
    </div>
  </footer>
